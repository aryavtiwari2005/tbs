                ...
                <section class="text-gray-600 body-font">
                    <div class="container px-5 py-24 mx-auto">
                        <div class="flex flex-col text-center w-full mb-20">
                            ...
                            <p class="lg:w-2/3 mx-auto leading-relaxed text-base">TotalBiz-Solutions is a results-oriented consultancy dedicated to empowering organizations to achieve their full potential through operational excellence. Our agile approach delivers innovative solutions that drive sustained growth and profitability.
                                ...
                                Let us help you unlock your organization's full potential. Contact us today to schedule a consultation.
                            </p>
                        </div>
                        <div class="flex flex-col text-center w-full mb-20">
                        ...
                        <div class="flex flex-wrap -m-4">
                            <div class="p-4 lg:w-1/2 md:w-1/2">
                                <div class="h-full flex flex-col items-center text-center">
                                    <img alt="team" class="flex-shrink-0 rounded-lg w-full h-85 object-cover object-center mb-4" src={anand} />
                                    <div class="w-full">
                            ...
                            <div class="p-4 lg:w-1/2 md:w-1/2">
                                <div class="h-full flex flex-col items-center text-center">
                                    <img alt="team" class="flex-shrink-0 rounded-lg w-full h-45 object-cover mb-4" src={rakesh} />
                                    <div class="w-full">
